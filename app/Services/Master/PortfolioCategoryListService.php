...
class PortfolioCategoryListService extends ListGenerator
{
  ...
  public function getHeaders(): array
  {
    $headers = [
      [
        'key' => 'title',
        'label' => trans('master.portfoliocategory.props.title'),
        'sortable' => true,
        'visibility' => true,
      ],
    ];
  ...
  public function paginate(Request $request): AnonymousResourceCollection
  {
    ...
    return PortfolioCategoryResource::collection($this->filter($request)
      ->orderBy($sort, $order)
