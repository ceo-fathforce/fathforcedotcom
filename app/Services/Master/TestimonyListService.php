...
class TestimonyListService extends ListGenerator
{
    ...
    public function getHeaders(): array
    {
        $headers = [
            [
                'key' => 'name',
                'label' => trans('master.testimony.props.name'),
                'sortable' => true,
                'visibility' => true,
            ],
            [
                'key' => 'description',
                'label' => trans('master.testimony.props.description'),
                'sortable' => false,
                'visibility' => true,
            ],
        ];
    ...
    public function paginate(Request $request): AnonymousResourceCollection
    {
        ...
        return TestimonyResource::collection($this->filter($request)
            ->orderBy($sort, $order)
