...
class PartnerSchoolListService extends ListGenerator
{
  ...
  public function getHeaders(): array
  {
    $headers = [
      [
        'key' => 'name',
        'label' => trans('master.partnerschool.props.name'),
        'sortable' => true,
        'visibility' => true,
      ],
      [
        'key' => 'description',
        'label' => trans('master.partnerschool.props.description'),
        'sortable' => false,
        'visibility' => true,
      ],
    ];
  ...
  public function paginate(Request $request): AnonymousResourceCollection
  {
    ...
    return PartnerSchoolResource::collection($this->filter($request)
      ->orderBy($sort, $order)
