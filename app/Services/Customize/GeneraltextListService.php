...
class GeneraltextListService extends ListGenerator
{
    ...
    public function getHeaders(): array
    {
        $headers = [
            [
                'key' => 'name',
                'label' => trans('customize.generaltext.props.name'),
                'sortable' => true,
                'visibility' => true,
            ],
        ];
    ...
    public function paginate(Request $request): AnonymousResourceCollection
    {
        ...
        return GeneraltextResource::collection($this->filter($request)
            ->orderBy($sort, $order)
