...
class CompanytextListService extends ListGenerator
{
    ...
    public function getHeaders(): array
    {
        $headers = [
            [
                'key' => 'name',
                'label' => trans('customize.companytext.props.name'),
                'sortable' => true,
                'visibility' => true,
            ],
        ];
    ...
    public function paginate(Request $request): AnonymousResourceCollection
    {
        ...
        return CompanytextResource::collection($this->filter($request)
            ->orderBy($sort, $order)
