                    ...
                    <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
                        <div class="post-header">
                            <div class="post-category text-line">
                                <a href="#" class="hover" rel="category">{{ $products->name }} </a>
                            </div>
                            <!-- /.post-category -->
                            <h1 class="display-1 mb-3">{{ $products->name }}</h1>
                        </div>
                        <!-- /.post-header -->
                    </div>
                    <!-- /column -->
          ...
          <div class="container py-10">
              <div class="row gx-md-6 gy-3 gy-md-0">
                  <div class="col-md-6 align-self-center text-center text-md-start navigation">
                      @if ($prevProduct)
                          <a href="{{ url('products/detail/' . $prevProduct->uuid) }}"
                  ...
                  <div class="col-md-6 align-self-center text-center text-md-end navigation">
                      @if ($nextProduct)
                          <a href="{{ url('products/detail/' . $nextProduct->uuid) }}"
